// src/components/Wallet.test.jsp
...
describe('Wallet', () => {
    ...
    const props = { balance: 20, deposit: mockDeposit, withdrawAction: mockWithdraw };
    ...
    it('creates an input to deposit inot or withdraw from the balance', () => {
